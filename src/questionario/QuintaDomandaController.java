 ...
 * @author cipri
 */
public class QuintaDomandaController implements Initializable {
    ...
    void doBack(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("QuartaDomanda.fxml"));
    ...
    void doCinque(ActionEvent event) {
        Questionario.vettore[4] = 5;
    }

    @FXML
    void doDieci(ActionEvent event) {
        Questionario.vettore[4] = 10;
    }

    @FXML
    void doDue(ActionEvent event) {
        Questionario.vettore[4] = 2;
    }
    ...
    void doNove(ActionEvent event) {
        Questionario.vettore[4] = 9;
    }

    @FXML
    void doOtto(ActionEvent event) {
        Questionario.vettore[4] = 8;
    }

    @FXML
    void doQuattro(ActionEvent event) {
        Questionario.vettore[4] = 4;
    }

    @FXML
    void doSei(ActionEvent event) {
        Questionario.vettore[4] = 6;
    }

    @FXML
    void doSette(ActionEvent event) {
        Questionario.vettore[4] = 7;
    }

    @FXML
    void doTre(ActionEvent event) {
        Questionario.vettore[4] = 3;
    }

    @FXML
    void doUno(ActionEvent event) {
        Questionario.vettore[4] = 1;
    }

    @Override
    public void initialize(URL url, ResourceBundle rb) {
       switch ( Questionario.vettore[4]){
