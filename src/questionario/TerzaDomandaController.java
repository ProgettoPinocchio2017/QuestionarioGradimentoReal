 ...
 * @author cipri
 */
public class TerzaDomandaController implements Initializable {
     @FXML
 ...
 Questionario.vettore[2] = 5;
    }

    @FXML
    void doDieci(ActionEvent event) {
 Questionario.vettore[2] = 10;
    }

    @FXML
    void doDue(ActionEvent event) {
 Questionario.vettore[2] = 2;
    }
