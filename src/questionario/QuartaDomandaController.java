 ...
 * @author cipri
 */
public class QuartaDomandaController implements Initializable {
    ...
    void doCinque(ActionEvent event) {
        Questionario.vettore[3] = 5;
    }

    @FXML
    void doDieci(ActionEvent event) {
        Questionario.vettore[3] = 10;
    }

    @FXML
    void doDue(ActionEvent event) {
        Questionario.vettore[3] = 2;
    }
    ...
    void doNove(ActionEvent event) {
        Questionario.vettore[3] = 9;
    }

    @FXML
    void doOtto(ActionEvent event) {
        Questionario.vettore[3] = 8;
    }

    @FXML
    void doQuattro(ActionEvent event) {
        Questionario.vettore[3] = 4;
    }

    @FXML
    void doSei(ActionEvent event) {
        Questionario.vettore[3] = 6;
    }

    @FXML
    void doSette(ActionEvent event) {
        Questionario.vettore[3] = 7;
    }

    @FXML
    void doTre(ActionEvent event) {
        Questionario.vettore[3] = 3;
    }

    @FXML
    void doUno(ActionEvent event) {
        Questionario.vettore[3] = 1;
    }

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        switch ( Questionario.vettore[3]){
