 ...
 * @author cipri
 */
public class SestaDomandaController implements Initializable {
    ...
    void doBack(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("QuintaDomanda.fxml"));
    ...
    void doCinque(ActionEvent event) {
        Questionario.vettore[5] = 5;
    }

    @FXML
    void doDieci(ActionEvent event) {
        Questionario.vettore[5] = 10;
    }

    @FXML
    void doDue(ActionEvent event) {
        Questionario.vettore[5] = 2;
    }

    @FXML
    void doNext(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("SettimaDomanda.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
    ...
    void doNove(ActionEvent event) {
        Questionario.vettore[5] = 9;
    }

    @FXML
    void doOtto(ActionEvent event) {
        Questionario.vettore[5] = 8;
    }

    @FXML
    void doQuattro(ActionEvent event) {
        Questionario.vettore[5] = 4;
    }

    @FXML
    void doSei(ActionEvent event) {
        Questionario.vettore[5] = 6;
    }

    @FXML
    void doSette(ActionEvent event) {
        Questionario.vettore[5] = 7;
    }

    @FXML
    void doTre(ActionEvent event) {
        Questionario.vettore[5] = 3;
    }

    @FXML
    void doUno(ActionEvent event) {
        Questionario.vettore[5] = 1;
    }

    @Override
    public void initialize(URL url, ResourceBundle rb) {
      switch ( Questionario.vettore[5]){
